...
PoolTable::PoolTable(std::string id, std::string manufacturer, double price, std::string dateOfManufacture, std::string type, std::string color, float length, float width)
